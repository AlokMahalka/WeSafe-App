    ...
    public void toggleFlashLight(View view) {
        if (toggleFlashLightOnOff.isChecked()) {
            ...
            try {
                ...
                Toast.makeText(FlashLight.this, "Flashlight is turned ON", Toast.LENGTH_SHORT).show();
            } catch (CameraAccessException e) {
            ...
            try {
                ...
                // Inform the user about the flashlight
                // status using Toast message
                Toast.makeText(FlashLight.this, "Flashlight is turned OFF", Toast.LENGTH_SHORT).show();
            } catch (CameraAccessException e) {
                // prints stack trace on standard error
                // output error stream
                e.printStackTrace();
